...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    private int getMagnitudeColor(double originalMag) {
        int color;
        int mag = ((int) Math.round(originalMag));
...
//
//    private String formatPrimaryLocation(String loc){
//
//        if(loc.contains("of")){
//            loc = loc.substring(loc.indexOf("of") + 3);
//        }
//
//        return loc;
//    }
//
//    private String formateOffset(String loc){
//        if(loc.contains("of")){
//            loc = loc.substring(0, loc.indexOf("of") +2);
//        }else {
//            loc = "Near the";
//        }
//
